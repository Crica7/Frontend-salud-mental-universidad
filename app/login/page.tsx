      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg text-center">Accede a tu cuenta</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="Tu contraseña" className="h-11" />
            </div>
            ...
            <Button variant="outline" className="w-full h-11 bg-transparent">
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                ...
                />
                <path fill="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
                <path
                  fill="currentColor"
